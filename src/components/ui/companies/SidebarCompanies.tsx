...
const SidebarCompanies: FC<SidebarCompaniesProps> = (props: SidebarCompaniesProps): ReactElement => {
  ...
  return (
    <>
      ...
      <FlexContainer isFlexJustifyStart>
        <Input type='text' placeholder='Search By Id' className='el-w1' onKeyUp={changeIdStat} />
      </FlexContainer>
