...
const AgentInformation: FC<AgentInformationType> = (props): ReactElement => {
	...
	return (
		<CardWrap style={{ width: '20%' }}>
			<CardListHeading style={{ textAlign: 'center', marginBottom: '1rem' }}>Agent</CardListHeading>
			<CardImageWrap style={{ width: '100%', height: '250px' }}>
				<img src='https://via.placeholder.com/52x52.svg' alt='asd' />
			</CardImageWrap>
			<CardListMainWrap>
				<CardListSubHeading className='el-has-bold-text'>{singleAgentInformation?.name}</CardListSubHeading>
			</CardListMainWrap>
			<CardListItem>
				<CardListIcon>
				...
				<CardListItemTextWrap>
					...
					<CardListItemTextSecondary>{singleAgentInformation?.mobilePhone ?? '-'}</CardListItemTextSecondary>
				</CardListItemTextWrap>
			</CardListItem>
			<CardListItem>
				<CardListIcon>
				...
				<CardListItemTextWrap>
					...
					<CardListItemTextSecondary>{singleAgentInformation?.email ?? '-'}</CardListItemTextSecondary>
				</CardListItemTextWrap>
			</CardListItem>
		</CardWrap>
	);
