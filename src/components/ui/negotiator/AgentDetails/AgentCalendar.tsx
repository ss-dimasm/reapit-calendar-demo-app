...
const AgentCalendar: FC<AgentCalendarProps> = (props): ReactElement => {
  ...
  const [singleAppointmentDate, setSingleAppointmentDate] =
  ...
  if (props.appointmentData === undefined)
    return <Loading text="getting appointments data" isCenter isFullScreen />
